...
import Calendar from '~/model/App/View/ListLayouts/Calendar';
...
interface Prop {
	records: Record[],
	app: App & { view: { list: Calendar; }; },
}
export default function CardList({ records, app }: Prop) {
	const layout = new Calendar(app.view.list);
	return <>
		<div className="grid">
			{records.map((record) => (
