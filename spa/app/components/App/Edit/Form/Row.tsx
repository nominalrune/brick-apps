...
type Select = ({ position, input }: { position: Position, input: Widget; }) => void;

export default function AppFormRow({ row, rowIndex, select, remove }: { row: Widget[], rowIndex: number, select: Select, remove: ([x, y]: Position) => void; }) {
